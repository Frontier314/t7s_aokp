...
namespace android {
    class ISecTVOut: public IInterface
    {
        public:
	     ...
	     virtual void setHdmiFlip(uint32_t flipVal, uint32_t hwcLayer)=0; //yqf test
	     virtual void saveHdmiRotate(uint32_t rotVal) = 0;	
    ...
    class BpSecTVOut: public BpInterface<ISecTVOut>
    {
        public:
	     ...
	     virtual void setHdmiFlip(uint32_t flipVal, uint32_t hwcLayer); //yqf test
	     virtual void saveHdmiRotate(uint32_t rotVal);
