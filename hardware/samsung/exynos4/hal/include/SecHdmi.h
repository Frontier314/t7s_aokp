...
private :
    ...
    unsigned int mUIFlipVal;	       // FIXed by Frontier
...
public :
    ...
    bool	setUIFlip(unsigned int flipVal, unsigned int hwcLayer);	// FIXed by Frontier
    bool	 mRotateInfoChange;    // FIXed by Frontier
