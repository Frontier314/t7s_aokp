...
TARGET_HAL_PATH := $(call my-dir)
TARGET_OMX_PATH : $(SAM_ROOT)/exynos/multimedia/openmax

#ifeq ($(TARGET_BOARD_PLATFORM),exynos4)

common_exynos4_dirs := lib libgralloc_ump libhwcomposer libhwconverter libswconverter libhdmi libsecion libaudio libaudiohw libcsc libcamera
